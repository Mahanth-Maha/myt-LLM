...
from optimizer_config import get_metrics_from_loader, create_optimizer, create_scheduler
from amd_gpu_settting import setup_complete_amd_environment, compile_model_amd
...
def main():
    ...
    val_dataset_streamer = ValidationDatasetStreamer(directory_list, context_length=context_length)
    ...
    total_steps = len(train_loader) // (batch_size * context_length)
