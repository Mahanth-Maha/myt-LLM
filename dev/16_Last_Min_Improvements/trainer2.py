...
class GeneralTrainer:
    def __init__(self, model, optimizer, loss_fn, train_loader, val_loader,
        ...
        self.tc.keep_last = keep_last if keep_last is not None else self.tc.keep_last
    ...
    def train(self, num_epochs, val_iters=100, save_steps=500, max_steps=10000, force_epochs=False, resume_train=True):
        ...
        self.tc.save_every_steps = save_steps if save_steps is not None else self.tc.save_every_steps
        ...
        ckpt_path = self.save_checkpoint(self.global_step, async_write=False)
    ...
    def save_checkpoint(self, step_or_iter, async_write=True):
