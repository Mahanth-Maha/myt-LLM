...
class DecoderOnlyTransformer(nn.Module):
    def __init__(self, vocab_size, context_length, model_dimension, n_heads, Nx_blocks, ffn_hid_dim, n_kv_heads =None, dropout=DROPOUT_DEFAULT, tie_weights=True, init_std_val = 0.02, use_checkpoint=False, checkpoint_ratio = 0.5):
        super().__init__()
